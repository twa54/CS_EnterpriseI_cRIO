 ...
 */
#ifndef RTW_HEADER_CSE1_HIL_tau_h_
#define RTW_HEADER_CSE1_HIL_tau_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef CSE1_HIL_tau_COMMON_INCLUDES_
# define CSE1_HIL_tau_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* CSE1_HIL_tau_COMMON_INCLUDES_ */

#include "CSE1_HIL_tau_types.h"
...
#define CSE1_HIL_tau_rtModel           RT_MODEL_CSE1_HIL_tau_T
...
typedef struct {
  ...
  uint8_T integrator_reset_DWORK2[13]; /* '<Root>/integrator_reset' */
  uint8_T x_DWORK2[13];                /* '<S1>/x' */
  uint8_T y_DWORK2[13];                /* '<S1>/y' */
  uint8_T psi_DWORK2[13];              /* '<S1>/psi' */
  uint8_T u_DWORK2[13];                /* '<S5>/u' */
  uint8_T v_DWORK2[13];                /* '<S5>/v' */
  uint8_T r_DWORK2[13];                /* '<S5>/r' */
  uint8_T psi_0_DWORK2[13];            /* '<S2>/psi_0' */
  uint8_T x_0_DWORK2[13];              /* '<S2>/x_0' */
  uint8_T y_0_DWORK2[13];              /* '<S2>/y_0' */
  uint8_T X_DWORK2[13];                /* '<S6>/X' */
  uint8_T Y_DWORK2[13];                /* '<S6>/Y' */
  uint8_T N_DWORK2[13];                /* '<S6>/N' */
} DW_CSE1_HIL_tau_T;
...
#define rtB                            CSE1_HIL_tau_B
#define BlockIO                        B_CSE1_HIL_tau_T
#define rtX                            CSE1_HIL_tau_X
#define ContinuousStates               X_CSE1_HIL_tau_T
#define rtXdot                         CSE1_HIL_tau_XDot
#define StateDerivatives               XDot_CSE1_HIL_tau_T
#define tXdis                          CSE1_HIL_tau_XDis
#define StateDisabled                  XDis_CSE1_HIL_tau_T
#define rtP                            CSE1_HIL_tau_P
#define Parameters                     P_CSE1_HIL_tau_T
#define rtDWork                        CSE1_HIL_tau_DW
#define D_Work                         DW_CSE1_HIL_tau_T
#define rtPrevZCSigState               CSE1_HIL_tau_PrevZCX
#define PrevZCSigStates                PrevZCX_CSE1_HIL_tau_T

/* Parameters (auto storage) */
struct P_CSE1_HIL_tau_T_ {
...
extern P_CSE1_HIL_tau_T CSE1_HIL_tau_P;

/* Block signals (auto storage) */
extern B_CSE1_HIL_tau_T CSE1_HIL_tau_B;

/* Continuous states (auto storage) */
extern X_CSE1_HIL_tau_T CSE1_HIL_tau_X;

/* Block states (auto storage) */
extern DW_CSE1_HIL_tau_T CSE1_HIL_tau_DW;

/* Model entry point functions */
extern void CSE1_HIL_tau_initialize(void);
extern void CSE1_HIL_tau_output(void);
extern void CSE1_HIL_tau_update(void);
extern void CSE1_HIL_tau_terminate(void);

/* Real-time Model object */
extern RT_MODEL_CSE1_HIL_tau_T *const CSE1_HIL_tau_M;
 ...
 * '<Root>' : 'CSE1_HIL_tau'
 * '<S1>'   : 'CSE1_HIL_tau/eta'
 * '<S2>'   : 'CSE1_HIL_tau/eta_0'
 * '<S3>'   : 'CSE1_HIL_tau/kinematics'
 * '<S4>'   : 'CSE1_HIL_tau/kinetics'
 * '<S5>'   : 'CSE1_HIL_tau/nu'
 * '<S6>'   : 'CSE1_HIL_tau/tau'
 */
#endif                                 /* RTW_HEADER_CSE1_HIL_tau_h_ */
...
P_CSE1_HIL_tau_T rtParameter[NUMST+!TID01EQ];
P_CSE1_HIL_tau_T *param_lookup[NUMST][2] = {
...
P_CSE1_HIL_tau_T rtParameter[2];
...
extern int tid;
extern P_CSE1_HIL_tau_T* param_lookup[NUMST][2];

#else

extern P_CSE1_HIL_tau_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define CSE1_HIL_tau_P                 (*param_lookup[tid][READSIDE])
#else
#define CSE1_HIL_tau_P                 rtParameter[READSIDE]
#endif
#endif
#endif
