...
#
# File    : Ctrl_Kjerstad_DP_1.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= Ctrl_Kjerstad_DP_1
MODULES         		:= Ctrl_Kjerstad_DP_1_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		:= Ctrl_Kjerstad_DP_1.mk
...
MODELLIB                  := Ctrl_Kjerstad_DP_1lib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\Ctrl_Kjerstad_DP_1_niVeriStand_VxWorks_rtw
