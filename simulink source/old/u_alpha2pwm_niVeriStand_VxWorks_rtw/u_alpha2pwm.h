 ...
 */
#ifndef RTW_HEADER_u_alpha2pwm_h_
#define RTW_HEADER_u_alpha2pwm_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef u_alpha2pwm_COMMON_INCLUDES_
# define u_alpha2pwm_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* u_alpha2pwm_COMMON_INCLUDES_ */

#include "u_alpha2pwm_types.h"
...
#define u_alpha2pwm_rtModel            RT_MODEL_u_alpha2pwm_T
...
typedef struct {
  ...
  uint8_T alpha_VSP1_DWORK2[12];       /* '<Root>/alpha_VSP1' */
  uint8_T omega_VSP1_DWORK2[12];       /* '<Root>/omega_VSP1' */
  uint8_T pwm_VSP1_DWORK2[12];         /* '<Root>/pwm_VSP1' */
  uint8_T u_VSP1_DWORK2[12];           /* '<Root>/u_VSP1' */
  uint8_T omega_VSP2_DWORK2[12];       /* '<Root>/omega_VSP2' */
  uint8_T pwm_VSP2_DWORK2[12];         /* '<Root>/pwm_VSP2' */
  uint8_T alpha_VSP2_DWORK2[12];       /* '<Root>/alpha_VSP2' */
  uint8_T u_BT_DWORK2[12];             /* '<Root>/u_BT' */
  uint8_T pwm_BT_DWORK2[12];           /* '<Root>/pwm_BT' */
  uint8_T u_VSP2_DWORK2[12];           /* '<Root>/u_VSP2' */
  uint8_T pwm_servo4_DWORK2[12];       /* '<Root>/pwm_servo4' */
  uint8_T pwm_servo3_DWORK2[12];       /* '<Root>/pwm_servo3' */
  uint8_T pwm_servo1_DWORK2[12];       /* '<Root>/pwm_servo1' */
  uint8_T pwm_servo2_DWORK2[12];       /* '<Root>/pwm_servo2' */
...
#define rtB                            u_alpha2pwm_B
#define BlockIO                        B_u_alpha2pwm_T
#define rtP                            u_alpha2pwm_P
#define Parameters                     P_u_alpha2pwm_T
#define rtDWork                        u_alpha2pwm_DW
#define D_Work                         DW_u_alpha2pwm_T

/* Parameters (auto storage) */
struct P_u_alpha2pwm_T_ {
...
extern P_u_alpha2pwm_T u_alpha2pwm_P;

/* Block signals (auto storage) */
extern B_u_alpha2pwm_T u_alpha2pwm_B;

/* Block states (auto storage) */
extern DW_u_alpha2pwm_T u_alpha2pwm_DW;

/* Real-time Model object */
extern RT_MODEL_u_alpha2pwm_T *const u_alpha2pwm_M;
 ...
 * '<Root>' : 'u_alpha2pwm'
 */
#endif                                 /* RTW_HEADER_u_alpha2pwm_h_ */
...
P_u_alpha2pwm_T rtParameter[NUMST+!TID01EQ];
P_u_alpha2pwm_T *param_lookup[NUMST][2] = {
  { &rtParameter[0], &rtParameter[1] },
};

#else

P_u_alpha2pwm_T rtParameter[2];
...
extern int tid;
extern P_u_alpha2pwm_T* param_lookup[NUMST][2];

#else

extern P_u_alpha2pwm_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define u_alpha2pwm_P                  (*param_lookup[tid][READSIDE])
#else
#define u_alpha2pwm_P                  rtParameter[READSIDE]
#endif
#endif
#endif
