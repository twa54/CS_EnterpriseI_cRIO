...
# define u_alpha2pwm_P                 u_alpha2pwm_P DataSection(".NIVS.defaultparams")
#endif
...
NI_ParamSizeWidth P_u_alpha2pwm_T_sizes[] DataSection(".NIVS.defaultparamsizes")
  = {
  { sizeof(P_u_alpha2pwm_T), 1 },
