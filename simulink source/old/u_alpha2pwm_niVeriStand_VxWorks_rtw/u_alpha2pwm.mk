...
#
# File    : u_alpha2pwm.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= u_alpha2pwm
MODULES         		:= NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c u_alpha2pwm_data.c 
MAKEFILE        		:= u_alpha2pwm.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\u_alpha2pwm_niVeriStand_VxWorks_rtw
