...
#
# File    : ctrl_TA_basic.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_TA_basic
MODULES         		:= NIVeriStand_main.c ctrl_TA_basic_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_TA_basic.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\ctrl_TA_basic_niVeriStand_VxWorks_rtw
