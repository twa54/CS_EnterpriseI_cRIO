 ...
 */
#ifndef RTW_HEADER_ctrl_TA_basic_h_
#define RTW_HEADER_ctrl_TA_basic_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef ctrl_TA_basic_COMMON_INCLUDES_
# define ctrl_TA_basic_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* ctrl_TA_basic_COMMON_INCLUDES_ */

#include "ctrl_TA_basic_types.h"
...
#define ctrl_TA_basic_rtModel          RT_MODEL_ctrl_TA_basic_T
...
typedef struct {
  ...
  uint8_T N_DWORK2[14];                /* '<Root>/N' */
  uint8_T VSP_on_DWORK2[14];           /* '<Root>/VSP_on' */
...
#define rtB                            ctrl_TA_basic_B
#define BlockIO                        B_ctrl_TA_basic_T
#define rtP                            ctrl_TA_basic_P
#define Parameters                     P_ctrl_TA_basic_T
#define rtDWork                        ctrl_TA_basic_DW
#define D_Work                         DW_ctrl_TA_basic_T

/* Parameters (auto storage) */
struct P_ctrl_TA_basic_T_ {
...
struct tag_RTM_ctrl_TA_basic_T {
  const char_T *path;
...
extern P_ctrl_TA_basic_T ctrl_TA_basic_P;

/* Block signals (auto storage) */
extern B_ctrl_TA_basic_T ctrl_TA_basic_B;

/* Block states (auto storage) */
extern DW_ctrl_TA_basic_T ctrl_TA_basic_DW;

/* Real-time Model object */
extern RT_MODEL_ctrl_TA_basic_T *const ctrl_TA_basic_M;
 ...
 *
 * '<Root>' : 'ctrl_TA_basic'
 * '<S1>'   : 'ctrl_TA_basic/Thrust allocation'
 */
#endif                                 /* RTW_HEADER_ctrl_TA_basic_h_ */
