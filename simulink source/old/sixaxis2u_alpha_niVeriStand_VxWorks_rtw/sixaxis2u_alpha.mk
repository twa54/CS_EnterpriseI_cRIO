...
#
# File    : NIVeriStand_VxXorks.tmf (for Release 14.0)
#
# Abstract:
...
MODEL           		:= sixaxis2u_alpha
MODULES         		:= NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c sixaxis2u_alpha_data.c 
MAKEFILE        		:= sixaxis2u_alpha.mk
...
MODELLIB                  := sixaxis2u_alphalib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\sixaxis2u_alpha_niVeriStand_VxWorks_rtw
...
REQ_SRCS  := $(MODEL).c $(MODULES) rt_sim.c \
	    $(SOLVER) $(LOG_SRC)
