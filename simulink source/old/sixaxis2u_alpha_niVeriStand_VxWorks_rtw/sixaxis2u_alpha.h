 ...
 */
#ifndef RTW_HEADER_sixaxis2u_alpha_h_
#define RTW_HEADER_sixaxis2u_alpha_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef sixaxis2u_alpha_COMMON_INCLUDES_
# define sixaxis2u_alpha_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* sixaxis2u_alpha_COMMON_INCLUDES_ */

#include "sixaxis2u_alpha_types.h"
...
#define sixaxis2u_alpha_rtModel        RT_MODEL_sixaxis2u_alpha_T
...
typedef struct {
  ...
  real_T L2_discrete;                  /* '<Root>/L2_discrete' */
  real_T L2_cont;                      /* '<Root>/L2_cont' */
  real_T R2_cont;                      /* '<Root>/R2_cont' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T R2_discrete;                  /* '<Root>/R2_discrete' */
  real_T ArrowUp;                      /* '<Root>/ArrowUp' */
  real_T ArrowDown;                    /* '<Root>/ArrowDown' */
  real_T Start;                        /* '<Root>/Start' */
  real_T Saturation_n;                 /* '<S3>/Saturation' */
  real_T R1;                           /* '<Root>/R1' */
  real_T Triangle;                     /* '<Root>/Triangle' */
  real_T Circle;                       /* '<Root>/Circle' */
  real_T Square;                       /* '<Root>/Square' */
  real_T Cross;                        /* '<Root>/Cross' */
  real_T Select;                       /* '<Root>/Select' */
  real_T ArrowLeft;                    /* '<Root>/ArrowLeft' */
  real_T ArrowRight;                   /* '<Root>/ArrowRight' */
  real_T L3;                           /* '<Root>/L3' */
  real_T R3;                           /* '<Root>/R3' */
} B_sixaxis2u_alpha_T;
...
typedef struct {
  ...
  real_T L2_discrete_DWORK1;           /* '<Root>/L2_discrete' */
  real_T L2_cont_DWORK1;               /* '<Root>/L2_cont' */
  real_T R2_cont_DWORK1;               /* '<Root>/R2_cont' */
  real_T u_BT_DWORK1;                  /* '<Root>/u_BT' */
  real_T R2_discrete_DWORK1;           /* '<Root>/R2_discrete' */
  ...
  real_T omega_VSP_DWORK1;             /* '<Root>/omega_VSP' */
  real_T R1_DWORK1;                    /* '<Root>/R1' */
  real_T Triangle_DWORK1;              /* '<Root>/Triangle' */
  real_T Circle_DWORK1;                /* '<Root>/Circle' */
  real_T Square_DWORK1;                /* '<Root>/Square' */
  real_T Cross_DWORK1;                 /* '<Root>/Cross' */
  real_T Select_DWORK1;                /* '<Root>/Select' */
  real_T ArrowLeft_DWORK1;             /* '<Root>/ArrowLeft' */
  real_T ArrowRight_DWORK1;            /* '<Root>/ArrowRight' */
  real_T L3_DWORK1;                    /* '<Root>/L3' */
  real_T R3_DWORK1;                    /* '<Root>/R3' */
  int32_T NIVeriStandSignalProbe_DWORK2;/* '<Root>/NIVeriStandSignalProbe' */
  uint8_T L1_DWORK2[16];               /* '<Root>/L1' */
  uint8_T PosXLeft_DWORK2[16];         /* '<Root>/PosXLeft' */
  uint8_T PosYLeft_DWORK2[16];         /* '<Root>/PosYLeft' */
  uint8_T u_1_DWORK2[16];              /* '<Root>/u_1' */
  uint8_T PosYRight_DWORK2[16];        /* '<Root>/PosYRight' */
  uint8_T PosXRight_DWORK2[16];        /* '<Root>/PosXRight' */
  uint8_T alpha_2_DWORK2[16];          /* '<Root>/alpha_2' */
  uint8_T alpha_1_DWORK2[16];          /* '<Root>/alpha_1' */
  uint8_T u_2_DWORK2[16];              /* '<Root>/u_2' */
  uint8_T L2_discrete_DWORK2[16];      /* '<Root>/L2_discrete' */
  uint8_T L2_cont_DWORK2[16];          /* '<Root>/L2_cont' */
  uint8_T R2_cont_DWORK2[16];          /* '<Root>/R2_cont' */
  uint8_T u_BT_DWORK2[16];             /* '<Root>/u_BT' */
  uint8_T R2_discrete_DWORK2[16];      /* '<Root>/R2_discrete' */
  uint8_T ArrowUp_DWORK2[16];          /* '<Root>/ArrowUp' */
  uint8_T ArrowDown_DWORK2[16];        /* '<Root>/ArrowDown' */
  uint8_T Start_DWORK2[16];            /* '<Root>/Start' */
  uint8_T omega_VSP_DWORK2[16];        /* '<Root>/omega_VSP' */
  uint8_T R1_DWORK2[16];               /* '<Root>/R1' */
  uint8_T Triangle_DWORK2[16];         /* '<Root>/Triangle' */
  uint8_T Circle_DWORK2[16];           /* '<Root>/Circle' */
  uint8_T Square_DWORK2[16];           /* '<Root>/Square' */
  uint8_T Cross_DWORK2[16];            /* '<Root>/Cross' */
  uint8_T Select_DWORK2[16];           /* '<Root>/Select' */
  uint8_T ArrowLeft_DWORK2[16];        /* '<Root>/ArrowLeft' */
  uint8_T ArrowRight_DWORK2[16];       /* '<Root>/ArrowRight' */
  uint8_T L3_DWORK2[16];               /* '<Root>/L3' */
  uint8_T R3_DWORK2[16];               /* '<Root>/R3' */
  uint8_T NIVeriStandSignalProbe_DWORK1[16];/* '<Root>/NIVeriStandSignalProbe' */
  uint8_T NIVeriStandSignalProbe_DWORK3[59];/* '<Root>/NIVeriStandSignalProbe' */
} DW_sixaxis2u_alpha_T;

/* Backward compatible GRT Identifiers */
#define rtB                            sixaxis2u_alpha_B
#define BlockIO                        B_sixaxis2u_alpha_T
#define rtP                            sixaxis2u_alpha_P
#define Parameters                     P_sixaxis2u_alpha_T
#define rtDWork                        sixaxis2u_alpha_DW
#define D_Work                         DW_sixaxis2u_alpha_T

/* Parameters (auto storage) */
struct P_sixaxis2u_alpha_T_ {
  ...
  real_T u_2_P6;                       /* Expression: btype
                                        * Referenced by: '<Root>/u_2'
                                        */
  real_T L2_discrete_P1;               /* Expression: width
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_discrete_P2;               /* Expression: dtype
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_discrete_P3;               /* Expression: portnum
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_discrete_P4;               /* Expression: stime
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_discrete_P5;               /* Expression: stype
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_discrete_P6;               /* Expression: btype
                                        * Referenced by: '<Root>/L2_discrete'
                                        */
  real_T L2_cont_P1;                   /* Expression: width
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T L2_cont_P2;                   /* Expression: dtype
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T L2_cont_P3;                   /* Expression: portnum
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T L2_cont_P4;                   /* Expression: stime
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T L2_cont_P5;                   /* Expression: stype
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T L2_cont_P6;                   /* Expression: btype
                                        * Referenced by: '<Root>/L2_cont'
                                        */
  real_T R2_cont_P1;                   /* Expression: width
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  real_T R2_cont_P2;                   /* Expression: dtype
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  real_T R2_cont_P3;                   /* Expression: portnum
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  real_T R2_cont_P4;                   /* Expression: stime
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  real_T R2_cont_P5;                   /* Expression: stype
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  real_T R2_cont_P6;                   /* Expression: btype
                                        * Referenced by: '<Root>/R2_cont'
                                        */
  ...
  real_T u_BT_P6;                      /* Expression: btype
                                        * Referenced by: '<Root>/u_BT'
                                        */
  real_T R2_discrete_P1;               /* Expression: width
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  real_T R2_discrete_P2;               /* Expression: dtype
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  real_T R2_discrete_P3;               /* Expression: portnum
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  real_T R2_discrete_P4;               /* Expression: stime
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  real_T R2_discrete_P5;               /* Expression: stype
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  real_T R2_discrete_P6;               /* Expression: btype
                                        * Referenced by: '<Root>/R2_discrete'
                                        */
  ...
  real_T Saturation_LowerSat_o;        /* Expression: -0.8
                                        * Referenced by: '<S3>/Saturation'
                                        */
  real_T omega_VSP_P1;                 /* Expression: width
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  real_T omega_VSP_P2;                 /* Expression: dtype
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  real_T omega_VSP_P3;                 /* Expression: portnum
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  real_T omega_VSP_P4;                 /* Expression: stime
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  real_T omega_VSP_P5;                 /* Expression: stype
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  real_T omega_VSP_P6;                 /* Expression: btype
                                        * Referenced by: '<Root>/omega_VSP'
                                        */
  ...
  real_T L3_P6;                        /* Expression: btype
                                        * Referenced by: '<Root>/L3'
                                        */
  real_T R3_P1;                        /* Expression: width
                                        * Referenced by: '<Root>/R3'
                                        */
  real_T R3_P2;                        /* Expression: dtype
                                        * Referenced by: '<Root>/R3'
                                        */
  real_T R3_P3;                        /* Expression: portnum
                                        * Referenced by: '<Root>/R3'
                                        */
  real_T R3_P4;                        /* Expression: stime
                                        * Referenced by: '<Root>/R3'
                                        */
  real_T R3_P5;                        /* Expression: stype
                                        * Referenced by: '<Root>/R3'
                                        */
  real_T R3_P6;                        /* Expression: btype
                                        * Referenced by: '<Root>/R3'
                                        */
...
struct tag_RTM_sixaxis2u_alpha_T {
  const char_T *path;
...
extern P_sixaxis2u_alpha_T sixaxis2u_alpha_P;

/* Block signals (auto storage) */
extern B_sixaxis2u_alpha_T sixaxis2u_alpha_B;

/* Block states (auto storage) */
extern DW_sixaxis2u_alpha_T sixaxis2u_alpha_DW;

/* Real-time Model object */
extern RT_MODEL_sixaxis2u_alpha_T *const sixaxis2u_alpha_M;
 ...
 *
 * '<Root>' : 'sixaxis2u_alpha'
 * '<S1>'   : 'sixaxis2u_alpha/Subsystem'
 * '<S2>'   : 'sixaxis2u_alpha/Subsystem1'
 * '<S3>'   : 'sixaxis2u_alpha/VSP omega'
 * '<S4>'   : 'sixaxis2u_alpha/VSP omega/Detect Increase'
 * '<S5>'   : 'sixaxis2u_alpha/VSP omega/Detect Increase1'
 * '<S6>'   : 'sixaxis2u_alpha/VSP omega/Detect Increase2'
 * '<S7>'   : 'sixaxis2u_alpha/VSP omega/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_sixaxis2u_alpha_h_ */
...
P_sixaxis2u_alpha_T rtParameter[NUMST+!TID01EQ];
P_sixaxis2u_alpha_T *param_lookup[NUMST][2] = {
  { &rtParameter[0], &rtParameter[1] },
};

#else

P_sixaxis2u_alpha_T rtParameter[2];
...
extern int tid;
extern P_sixaxis2u_alpha_T* param_lookup[NUMST][2];

#else

extern P_sixaxis2u_alpha_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define sixaxis2u_alpha_P              (*param_lookup[tid][READSIDE])
#else
#define sixaxis2u_alpha_P              rtParameter[READSIDE]
#endif
#endif
#endif
