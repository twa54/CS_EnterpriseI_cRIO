...
MODEL           		:= Flip_switch
MODULES         		:= Flip_switch_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= Flip_switch.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\Flip_switch_niVeriStand_VxWorks_rtw
