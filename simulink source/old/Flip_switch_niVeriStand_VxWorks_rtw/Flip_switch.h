 ...
 */
#ifndef RTW_HEADER_Flip_switch_h_
#define RTW_HEADER_Flip_switch_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef Flip_switch_COMMON_INCLUDES_
# define Flip_switch_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* Flip_switch_COMMON_INCLUDES_ */

#include "Flip_switch_types.h"
...
#define Flip_switch_rtModel            RT_MODEL_Flip_switch_T

/* Block signals (auto storage) */
typedef struct {
  real_T Ctrl_Switchsignal1;           /* '<Root>/Ctrl_Switch signal1' */
  real_T Sixaxis_Switchsignal;         /* '<Root>/Sixaxis_Switch signal' */
  real_T Sixaxis_alpha_1;              /* '<Root>/Sixaxis_alpha_1' */
  real_T Ctrl_alpha_1;                 /* '<Root>/Ctrl_alpha_1' */
  real_T Ctrl_u_1;                     /* '<Root>/Ctrl_u_1' */
  real_T Ctrl_alpha_2;                 /* '<Root>/Ctrl_alpha_2' */
  real_T Ctrl_u_2;                     /* '<Root>/Ctrl_u_2' */
  real_T Ctrl_u_BT2;                   /* '<Root>/Ctrl_u_BT2' */
  real_T Ctrl_omega_VSP1;              /* '<Root>/Ctrl_omega_VSP1' */
  real_T Ctrl_omega_VSP2;              /* '<Root>/Ctrl_omega_VSP2' */
  ...
  real_T Sixaxis_omega_VSP;            /* '<Root>/Sixaxis_omega_VSP' */
  real_T Switch1[7];                   /* '<Root>/Switch1' */
...
typedef struct {
  ...
  real_T Ctrl_Switchsignal1_DWORK1;    /* '<Root>/Ctrl_Switch signal1' */
  real_T Indicator_DWORK1;             /* '<Root>/Indicator' */
  real_T Sixaxis_Switchsignal_DWORK1;  /* '<Root>/Sixaxis_Switch signal' */
  ...
  real_T Ctrl_u_BT2_DWORK1;            /* '<Root>/Ctrl_u_BT2' */
  ...
  real_T Sixaxis_omega_VSP_DWORK1;     /* '<Root>/Sixaxis_omega_VSP' */
  ...
  uint8_T Ctrl_Switchsignal1_DWORK2[12];/* '<Root>/Ctrl_Switch signal1' */
  uint8_T Indicator_DWORK2[12];        /* '<Root>/Indicator' */
  uint8_T Sixaxis_Switchsignal_DWORK2[12];/* '<Root>/Sixaxis_Switch signal' */
  uint8_T Sixaxis_alpha_1_DWORK2[12];  /* '<Root>/Sixaxis_alpha_1' */
  ...
  uint8_T Ctrl_u_BT2_DWORK2[12];       /* '<Root>/Ctrl_u_BT2' */
  uint8_T Ctrl_omega_VSP1_DWORK2[12];  /* '<Root>/Ctrl_omega_VSP1' */
  uint8_T Ctrl_omega_VSP2_DWORK2[12];  /* '<Root>/Ctrl_omega_VSP2' */
  uint8_T Sixaxis_u_1_DWORK2[12];      /* '<Root>/Sixaxis_u_1' */
  uint8_T Sixaxis_alpha_2_DWORK2[12];  /* '<Root>/Sixaxis_alpha_2' */
  uint8_T Sixaxis_u_2_DWORK2[12];      /* '<Root>/Sixaxis_u_2' */
  uint8_T Sixaxis_u_BT_DWORK2[12];     /* '<Root>/Sixaxis_u_BT' */
  uint8_T Sixaxis_omega_VSP_DWORK2[12];/* '<Root>/Sixaxis_omega_VSP' */
  uint8_T alpha_1_DWORK2[12];          /* '<Root>/alpha_1' */
  uint8_T u_1_DWORK2[12];              /* '<Root>/u_1' */
  uint8_T alpha_2_DWORK2[12];          /* '<Root>/alpha_2' */
  uint8_T u_2_DWORK2[12];              /* '<Root>/u_2' */
  uint8_T U_BT_DWORK2[12];             /* '<Root>/U_BT' */
  uint8_T omega_VSP_1_DWORK2[12];      /* '<Root>/omega_VSP_1' */
  uint8_T omega_VSP_2_DWORK2[12];      /* '<Root>/omega_VSP_2' */
  uint8_T NIVeriStandSignalProbe_DWORK1[12];/* '<Root>/NIVeriStandSignalProbe' */
  uint8_T NIVeriStandSignalProbe_DWORK3[55];/* '<Root>/NIVeriStandSignalProbe' */
} DW_Flip_switch_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Flip_switch_B
#define BlockIO                        B_Flip_switch_T
#define rtP                            Flip_switch_P
#define Parameters                     P_Flip_switch_T
#define rtDWork                        Flip_switch_DW
#define D_Work                         DW_Flip_switch_T

/* Parameters (auto storage) */
struct P_Flip_switch_T_ {
  real_T Ctrl_Switchsignal1_P1;        /* Expression: width
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  real_T Ctrl_Switchsignal1_P2;        /* Expression: dtype
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  real_T Ctrl_Switchsignal1_P3;        /* Expression: portnum
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  real_T Ctrl_Switchsignal1_P4;        /* Expression: stime
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  real_T Ctrl_Switchsignal1_P5;        /* Expression: stype
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  real_T Ctrl_Switchsignal1_P6;        /* Expression: btype
                                        * Referenced by: '<Root>/Ctrl_Switch signal1'
                                        */
  ...
  real_T DiscreteTimeIntegrator_IC;    /* Expression: 0
                                        * Referenced by: '<Root>/Discrete-Time Integrator'
                                        */
  real_T Indicator_P1;                 /* Expression: width
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Indicator_P2;                 /* Expression: dtype
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Indicator_P3;                 /* Expression: portnum
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Indicator_P4;                 /* Expression: stime
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Indicator_P5;                 /* Expression: stype
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Indicator_P6;                 /* Expression: btype
                                        * Referenced by: '<Root>/Indicator'
                                        */
  real_T Sixaxis_Switchsignal_P1;      /* Expression: width
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
  real_T Sixaxis_Switchsignal_P2;      /* Expression: dtype
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
  real_T Sixaxis_Switchsignal_P3;      /* Expression: portnum
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
  real_T Sixaxis_Switchsignal_P4;      /* Expression: stime
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
  real_T Sixaxis_Switchsignal_P5;      /* Expression: stype
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
  real_T Sixaxis_Switchsignal_P6;      /* Expression: btype
                                        * Referenced by: '<Root>/Sixaxis_Switch signal'
                                        */
...
extern P_Flip_switch_T Flip_switch_P;

/* Block signals (auto storage) */
extern B_Flip_switch_T Flip_switch_B;

/* Block states (auto storage) */
extern DW_Flip_switch_T Flip_switch_DW;
...
extern RT_MODEL_Flip_switch_T *const Flip_switch_M;
 ...
 *
 * '<Root>' : 'Flip_switch'
 * '<S1>'   : 'Flip_switch/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_Flip_switch_h_ */
...
P_Flip_switch_T rtParameter[NUMST+!TID01EQ];
P_Flip_switch_T *param_lookup[NUMST][2] = {
...
extern int tid;
extern P_Flip_switch_T* param_lookup[NUMST][2];

#else

extern P_Flip_switch_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define Flip_switch_P                  (*param_lookup[tid][READSIDE])
#else
#define Flip_switch_P                  rtParameter[READSIDE]
#endif
#endif
#endif
