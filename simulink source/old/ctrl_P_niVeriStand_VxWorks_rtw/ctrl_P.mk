...
MODEL           		:= ctrl_P
MODULES         		:= NIVeriStand_main.c ctrl_P_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_P.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\ctrl_P_niVeriStand_VxWorks_rtw
