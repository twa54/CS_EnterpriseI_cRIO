...
#
# File    : Force_ctrl_sixaxis.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= Force_ctrl_sixaxis
MODULES         		:= Force_ctrl_sixaxis_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= Force_ctrl_sixaxis.mk
...
MODELLIB                  := Force_ctrl_sixaxislib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\Force_ctrl_sixaxis_niVeriStand_VxWorks_rtw
