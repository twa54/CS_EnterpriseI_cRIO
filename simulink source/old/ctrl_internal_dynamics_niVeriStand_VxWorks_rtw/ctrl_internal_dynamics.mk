...
#
# File    : ctrl_internal_dynamics.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_internal_dynamics
MODULES         		:= NIVeriStand_main.c ctrl_internal_dynamics_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_internal_dynamics.mk
...
MODELLIB                  := ctrl_internal_dynamicslib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\ctrl_internal_dynamics_niVeriStand_VxWorks_rtw
