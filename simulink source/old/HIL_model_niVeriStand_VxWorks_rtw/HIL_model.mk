...
#
# File    : HIL_model.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= HIL_model
MODULES         		:= HIL_model_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= HIL_model.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\HIL_model_niVeriStand_VxWorks_rtw
