...
typedef struct {
  ...
  real_T X;                            /* '<Root>/Thruster configuration matrix' */
  real_T Y;                            /* '<Root>/Thruster configuration matrix' */
  real_T N;                            /* '<Root>/Thruster configuration matrix' */
} B_CSE1_HIL_u_T;
...
typedef struct {
  ...
  uint8_T r_DWORK2[11];                /* '<S7>/r' */
  uint8_T u_DWORK2[11];                /* '<S7>/u' */
  uint8_T v_DWORK2[11];                /* '<S7>/v' */
  uint8_T u_BT_DWORK2[11];             /* '<S10>/u_BT' */
  uint8_T u_VSP1_DWORK2[11];           /* '<S10>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[11];           /* '<S10>/u_VSP2' */
  uint8_T alpha_VSP1_DWORK2[11];       /* '<S10>/alpha_VSP1' */
  uint8_T alpha_VSP2_DWORK2[11];       /* '<S10>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2[11];       /* '<S10>/omega_VSP1' */
  uint8_T omega_VSP2_DWORK2[11];       /* '<S10>/omega_VSP2' */
 ...
 *
 * '<Root>' : 'CSE1_HIL_u'
 * '<S1>'   : 'CSE1_HIL_u/Thruster configuration matrix'
 * '<S2>'   : 'CSE1_HIL_u/Thruster mapping'
 * '<S3>'   : 'CSE1_HIL_u/eta'
 * '<S4>'   : 'CSE1_HIL_u/eta_0'
 * '<S5>'   : 'CSE1_HIL_u/kinematics'
 * '<S6>'   : 'CSE1_HIL_u/kinetics'
 * '<S7>'   : 'CSE1_HIL_u/nu'
 * '<S8>'   : 'CSE1_HIL_u/nu_dot'
 * '<S9>'   : 'CSE1_HIL_u/tau'
 * '<S10>'  : 'CSE1_HIL_u/u'
 * '<S11>'  : 'CSE1_HIL_u/Thruster mapping/Bow thruster'
 * '<S12>'  : 'CSE1_HIL_u/Thruster mapping/VSP'
 */
...
#ifdef MULTITASKING
#define CSE1_HIL_u_P                   (*param_lookup[tid][READSIDE])
#else
#define CSE1_HIL_u_P                   rtParameter[READSIDE]
#endif
#endif
#endif
